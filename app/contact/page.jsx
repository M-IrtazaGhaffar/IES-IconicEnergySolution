...
function page() {
    ...
    return (
        <div class="px-6 py-24 sm:py-32 lg:px-8 bg-white text-black">
            <h2 class="text-4xl p-3 font-bold tracking-tight sm:text-6xl text-center">Contact Sales</h2>
            <div className='flex flex-wrap items-center justify-center'>
                ...
                <form action="https://formspree.io/f/xrgwkbdp" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                    ...
                    <div className='flex flex-col gap-3 lg:w-[30vw]'>
                        <div>
                            <label htmlFor="first-name" class="block text-xs font-semibold leading-6  ">First name</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-2">
                            <label htmlFor="company" class="block text-xs font-semibold leading-6  ">Company</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-2">
                            <label htmlFor="email" class="block text-xs font-semibold leading-6  ">Email</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-2">
                            <label htmlFor="phone-number" class="block text-xs font-semibold leading-6  ">Phone number</label>
                        ...
                        <div class="sm:col-span-2">
                            <label htmlFor="message" class="block text-xs font-semibold leading-6  ">Message</label>
                            <div class="mt-1">
                    ...
                    <div class="mt-5">
                        <button type="submit" class="block w-full rounded-md bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:scale-105 drop-shadow-2xl transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Let&#39;s talk</button>
                    </div>
                </form>
            </div>
