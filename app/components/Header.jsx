...
function Header() {
    return (
        <div className='min-h-screen flex flex-col justify-center items-center gap-6 text-center p-10'>
            ...
            <div className='w-12 h-12 bg-sky-700 blur-2xl absolute top-[35%] left-[70%]'></div>
            <div className='w-12 h-12 bg-sky-700 blur-2xl absolute top-[50%] left-[50%]'></div>
            <div className='w-12 h-12 bg-sky-700 blur-2xl absolute top-[20%] left-[85%]'></div>
            <div className='w-12 h-12 bg-sky-700 blur-2xl absolute top-[65%] left-[35%]'></div>
        </div>
    )
}
